...
title: "작은 씨앗에서 튼튼한 나무로: AI 학교 홍보영상"
date: 2026-06-30
category: 생성형 AI 영상 프로젝트
summary: "Veo 3, Nano Banana와 CapCut으로 기획·생성·편집하여 제8회 교육 공공데이터 AI 활용대회에 출품한 학교 홍보영상입니다."
tags: [Veo 3, Nano Banana, CapCut, 스토리텔링]
permalink: /ko/research/ai-school-promotion-film/
collection_url: /#research
back_label: 연구 목록으로
alternate_url: /research/ai-school-promotion-film/
...
학교와 공개 자료를 조사하고 장면별 스토리보드를 만들었습니다. Nano Banana로 이미지를 만들고 다듬은 뒤, Veo 3에서 짧은 영상을 반복 생성했습니다. 사용할 장면을 고르고 CapCut에서 순서, 길이와 전환을 편집해 1분이 넘는 완성본으로 연결했습니다.

## 어려웠던 점

인물과 움직임이 부자연스럽거나 장면마다 모습이 달라지는 문제가 있었습니다. 프롬프트를 고치고 여러 결과 중 사용할 부분을 고르는 작업이 반복되었습니다. AI가 영상을 한 번에 완성하는 것이 아니라, 사람이 메시지를 정하고 오류를 판단하며 최종 이야기를 선택해야 한다는 점을 배웠습니다.
